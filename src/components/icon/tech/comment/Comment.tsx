...
const Searcher: React.FC<CommentProps> = ({size = "small", intent = "unselected"}:CommentProps) => {
  return (
    <svg viewBox="0 0 32 28" xmlns="http://www.w3.org/2000/svg" className={comment({size, intent})}>
      <path
