...
type CommentProps = VariantProps<typeof commentIcon>;

const Comment: React.FC<CommentProps> = ({size = "medium", intent = "unselected"}:CommentProps) => {
  return (
    <svg viewBox="0 0 32 28" xmlns="http://www.w3.org/2000/svg" className={commentIcon({size, intent})}>
      <path
