...
export interface CommentProps extends React.SVGProps<SVGSVGElement>, VariantProps<typeof commentIcon> {}

const CommentIcon: React.FC<CommentProps> = ({ size = "medium", intent = "unselected", ...props }) => {
  return (
    <svg
      viewBox="0 0 32 28"
      xmlns="http://www.w3.org/2000/svg"
      className={commentIcon({ size, intent })}
      {...props}
    >
      <path
