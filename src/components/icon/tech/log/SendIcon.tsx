        ...
        <div className={audioIconStyles({ pressed })}>
            <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    ...
                    strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={pressed ? "fill-tertiary-100 stroke-tertiary-100" : "stroke-utility-border"}/>
                <path
                    d="M7.65 14H15.4582"
                    className={pressed ? "stroke-primary-900" : "stroke-black"} strokeWidth="1.5" strokeLinecap="round"
