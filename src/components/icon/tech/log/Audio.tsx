...
const AudioIcon: React.FC<AudioProps> = ({ pressed = false }: AudioProps) => { // Default pressed to false
  return (
    <div className={audioIconStyles({ pressed })}>
        <svg width="16" height="22" viewBox="0 0 16 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                strokeWidth="1.5" className={pressed ? "fill-tertiary-100 stroke-tertiary-100 ": "stroke-utility-border"}/>
            <path
                ...
                stroke={pressed ? "white" : "black"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M7.90918 17.1819V21.1819M7.90918 21.1819H4.90918M7.90918 21.1819H10.9092"
                  stroke={pressed ? "white" : "black"}
