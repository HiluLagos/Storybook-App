...
export const Dropdown: React.FC<DropdownProps> = ({ checkLists, title, dropped, topRightText }) => {
    ...
    return (
        <div className={`w-[328px] border-2 border-primary-100 rounded-2xl p-2 ${isOpen ? '' : 'h-10'} transition-all`}>
            <div className="flex justify-between items-center w-[308px] h-[24px] p-2 cursor-pointer" onClick={toggleDropdown}>
